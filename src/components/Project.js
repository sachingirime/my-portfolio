...
export default function Project() {
    ...
    return (
        ...
        <main className="bg-white min-h-screen p-12">
            ...
            <section className="container mx-auto mt-60 mb-8">
                <h1 className='text-5xl flex justify-center  font-bold mb-12'>My Skills</h1>
                <div className="text-2xl  flex justify-center mt-5 text-center">
                    <ul>
                    <li >Python</li>
                    <li>JavaScript</li>
